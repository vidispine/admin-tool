...
function ProjectionCreateOutgoing({
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth={false}>
      <DialogTitle>New Outgoing Projection</DialogTitle>
      <DialogContent>
        <ProjectionNameForm
          form={EDIT_PROJECTION_OUTGOING_FORM}
          onSubmit={formActions.onCreateOutgoing}
...
export default compose(withUI, withFormActions)(ProjectionCreateOutgoing);
