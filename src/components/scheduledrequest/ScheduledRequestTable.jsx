...
function ScheduledRequestTable({ scheduledRequestListDocument, onSuccess, dialogProps, onOpen }) {
  ...
  return (
    <>
      ...
      <ScheduledRequestDialog {...dialogProps} dialogName={SCHEDULEDREQUEST_DETAIL_DIALOG} />
