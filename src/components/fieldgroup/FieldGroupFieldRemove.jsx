...
function FieldGroupChildRemove({ open, onClose, openSnackBar, groupName, fieldName, onSuccess }) {
  const onRemove = () => {
    api
      .removeFieldGroupField({ groupName, fieldName })
      .then(() => {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth={false}>
      <DialogTitle>{`Remove "${fieldName}" From "${groupName}"?`}</DialogTitle>
      <DialogActions>
