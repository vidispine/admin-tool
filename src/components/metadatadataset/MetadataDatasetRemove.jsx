...
function MetadataDatasetRemove({ open, onClose, history, openSnackBar, datasetId, onSuccess }) {
  const onRemove = () => {
    api
      .removeMetadataDataset({ datasetId })
      .then(() => {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth={false}>
      <DialogTitle>{`Remove Metadata Dataset "${datasetId}"?`}</DialogTitle>
      <DialogActions>
