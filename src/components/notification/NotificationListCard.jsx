...
export default function NotificationListCard({ uriListDocument, entityType, entityId }) {
  ...
  return (
    <SquareCard>
      <CardContent>
        <UriListTable uriListDocument={uriListDocument} linkTo={linkTo} textTo={textTo} />
      </CardContent>
    </SquareCard>
  );
}
