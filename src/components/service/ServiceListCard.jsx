...
function ServiceListCard({ vidispineServiceListDocument, onRefresh, dialogProps, onOpen }) {
  ...
  return (
    <>
      ...
      <ServiceEnable {...dialogProps} dialogName={ENABLE_SERVICE_DIALOG} onSuccess={onRefresh} />
      <ServiceDisable {...dialogProps} dialogName={DISABLE_SERVICE_DIALOG} onSuccess={onRefresh} />
    </>
  );
}
