  ...
  return (
    <Menu>
      <MenuItem
        ...
        to={`/item/${itemId}/shape/${shapeId}/component/${componentId}/`}
      >
      ...
      {moveToComponentModal ? (
        <MenuItem
          onClick={() =>
            onOpen({
              modalName: moveToComponentModal,
              itemId,
              shapeId,
              componentId,
            })
      ...
      {copyToComponentModal ? (
        <MenuItem
          onClick={() =>
            onOpen({
              modalName: copyToComponentModal,
              itemId,
              shapeId,
              componentId,
            })
