...
const queryParams = () => (
  <>
    ...
    <Field name="rows" component={TextField} type="number" fullWidth />
    <Field
      name="username"
      ...
      fullWidth
    />
    <Field name="starttime" component={TextField} fullWidth />
    <Field name="endtime" component={TextField} fullWidth />
    <FormControlLabel
...
function AuditLogFilterForm({ error, handleSubmit }) {
  return (
