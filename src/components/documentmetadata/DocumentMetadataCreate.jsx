...
function DocumentMetadataCreate({ open, onClose, onSuccess, onFail, openSnackBar, submitForm }) {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth={false}>
      ...
      <DialogActions>
        ...
        <Button size="small" color="primary" onClick={() => submitForm(EDIT_DOCUMENT_FORM)}>
          Save
        </Button>
      </DialogActions>
    </Dialog>
