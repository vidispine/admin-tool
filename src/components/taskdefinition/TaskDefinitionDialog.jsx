...
function TaskDefinitionDialog({ jobType, submitForm, openSnackBar, onClose, onSuccess, open }) {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth={false}>
      ...
      <DialogActions>
        ...
        <Button size="small" color="primary" onClick={() => submitForm(EDIT_TASKDEFINITION_FORM)}>
          Save
        </Button>
      </DialogActions>
    </Dialog>
