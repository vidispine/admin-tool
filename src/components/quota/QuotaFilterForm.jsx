...
function QuotaFilterQueryParams() {
  return (
    <>
      <Grid container direction="column">
        <FieldArray name="filter" component={FilterArray} />
      </Grid>
      <FormControlLabel
        control={<Field name="exceeded" component={BoolCheckbox} />}
        label="Exceeded"
      />
      <FormControl fullWidth>
...
function QuotaFilterForm({ error, handleSubmit }) {
  return (
    <form onSubmit={handleSubmit}>
      {error && <Typography color="error">{error}</Typography>}
      <FormSection name="queryParams" component={QuotaFilterQueryParams} />
