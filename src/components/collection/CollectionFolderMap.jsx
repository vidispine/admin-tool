...
function CollectionFolderMap({
  ...
  useEffect(() => {
    ...
    CollectionApi.getCollectionMetadata({
      collectionId,
      queryParams: { field: '__folder_mapped', interval: 'generic' },
  ...
  const onMarkFolderCollection = () =>
    CollectionApi.markFolderCollection({
      collectionId,
    })
      .then(() => {
  ...
  const onUnMarkFolderCollection = () =>
    CollectionApi.unMarkFolderCollection({
      collectionId,
    })
      .then(() => {
