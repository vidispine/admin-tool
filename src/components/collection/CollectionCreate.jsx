...
function CollectionCreate({ submitForm, open, onClose, onSuccess, openSnackBar, onFail }) {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth={false}>
      ...
      <DialogActions>
        ...
        <Button size="small" color="primary" onClick={() => submitForm(EDIT_COLLECTION_FORM)}>
          Create
        </Button>
      </DialogActions>
    </Dialog>
